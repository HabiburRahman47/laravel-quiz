    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($quiz) {
                ...
                $editUrl = null;
                $showUrl = null;
                $deleteUrl = route('web.admin.quizzes.destroy', $id);
                $restoreUrl = null;
                $trashUrl = null;
                if ($quiz->trashed()) {
                    $restoreUrl = route('web.admin.quizzes.restore', $id);
                } else {
                    $trashUrl = route('web.admin.quizzes.trash', $id);
                    $editUrl = route('web.admin.quizzes.edit', $id);
                    $showUrl = route('web.admin.quizzes.show', $id);
                }
