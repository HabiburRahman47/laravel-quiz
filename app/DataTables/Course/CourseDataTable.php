    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($course) {
                ...
                $editUrl = null;
                $showUrl = null;
                $deleteUrl = route('web.admin.courses.destroy', $id);
                $restoreUrl = null;
                $trashUrl = null;
                if ($course->trashed()) {
                    $restoreUrl = route('web.admin.courses.restore', $id);
                } else {
                    $trashUrl = route('web.admin.courses.trash', $id);
                    $editUrl = route('web.admin.courses.edit', $id);
                    $showUrl = route('web.admin.courses.show', $id);
                }
