...
namespace App\Http\Controllers\API\V1\Site\Attendance;


use App\Http\Controllers\API\V1\Site\AdminAPIBaseController;
use App\Http\Requests\API\V1\Site\Attendance\AttendanceRequest;
use App\Http\Requests\API\V1\Site\Attendance\StoreAttendanceRequest;
use App\Http\Requests\API\V1\Site\Attendance\UpdateAttendanceRequest;
use App\Http\Resources\API\V1\Site\Attendance\AttendanceCollection;
