...
namespace App\Http\Controllers\API\V1\Site\Category;

use App\Http\Controllers\API\V1\Site\AdminAPIBaseController;
use App\Http\Controllers\Controller;
use App\Http\Requests\API\V1\Site\Category\StoreCategoryRequest;
use App\Http\Requests\API\V1\Site\Category\UpdateCategoryRequest;
use App\Http\Resources\API\V1\Site\Category\CategoryCollection;
use App\Http\Resources\API\V1\Site\Category\CategoryResource;
