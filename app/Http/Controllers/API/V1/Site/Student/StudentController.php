...
namespace App\Http\Controllers\API\V1\Site\Student;

use App\Http\Controllers\API\V1\Site\AdminAPIBaseController;
use App\Http\Requests\API\V1\Site\Student\StoreStudentRequest;
use App\Http\Requests\API\V1\Site\Student\StudentRequest;
use App\Http\Requests\API\V1\Site\Student\UpdateStudentRequest;
use App\Http\Resources\API\V1\Site\Student\StudentCollection;
