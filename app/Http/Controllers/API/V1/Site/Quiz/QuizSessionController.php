...
use App\Http\Requests\API\V1\Site\Quiz\StoreQuizSessionRequest;
use App\Http\Requests\API\V1\Site\Quiz\UpdateQuizSessionRequest;
use App\Http\Resources\API\V1\Site\Quiz\QuizSessionAnswerResource;
use App\Http\Resources\API\V1\Site\Quiz\QuizSessionCollection;
use App\Http\Resources\API\V1\Site\Quiz\QuizSessionResource;
...
class QuizSessionController extends AdminAPIBaseController
{
    ...
    public function index()
    {
        ...
        $quizSessions=QuizSession::with('result')
                ->where('created_by_id','=',$created_by_id)
                 ->get();
       //return response()->json($quizSessions);
        return new QuizSessionResource($quizSessions);
    }
