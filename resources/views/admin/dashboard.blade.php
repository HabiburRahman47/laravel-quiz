                        ...
                        <div class="card-body pb-0">
                            <div class="btn-group float-right">
                                <button class="btn btn-transparent dropdown-toggle p-0" type="button"
                                    ...
                                    <svg class="c-icon">
                                        <use xlink:href="core/assets/icons/coreui/free-symbol-defs.svg#cui-settings"></use>
                                    </svg>
                                </button>
                    ...
                    <div class="card text-white bg-info">
                        <div class="card-body pb-0">
                            <button class="btn btn-transparent p-0 float-right" type="button">
                                <svg class="c-icon">
                                    <use xlink:href="core/assets/icons/coreui/free-symbol-defs.svg#cui-location-pin"></use>
                                </svg>
                            </button>
                            <div class="text-value-lg">9.823</div>
                            <div>Members online</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 d-none d-md-block">
                            <button class="btn btn-primary float-right" type="button">
                                <svg class="c-icon">
                                    <use xlink:href="core/assets/icons/coreui/free-symbol-defs.svg#cui-cloud-download"></use>
                                </svg>
                            </button>
                    ...
                    <div class="card">
                        <div class="card-header bg-facebook content-center">
                            <svg class="c-icon c-icon-3xl text-white my-4">
                                <use xlink:href="core/assets/icons/brands/brands-symbol-defs.svg#facebook-f"></use>
                            </svg>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <div class="card-header bg-twitter content-center">
                            <svg class="c-icon c-icon-3xl text-white my-4">
                                <use xlink:href="core/assets/icons/brands/brands-symbol-defs.svg#twitter"></use>
                            </svg>
                            <div class="c-chart-wrapper">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <div class="card-header bg-linkedin content-center">
                            <svg class="c-icon c-icon-3xl text-white my-4">
                                <use xlink:href="core/assets/icons/brands/brands-symbol-defs.svg#linkedin"></use>
                            </svg>
                            <div class="c-chart-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="progress-group mb-4">
                                        <div class="progress-group-prepend"><span
                                                    class="progress-group-text">Monday</span></div>
                                    ...
                                    <div class="progress-group mb-4">
                                        <div class="progress-group-prepend"><span
                                                    class="progress-group-text">Tuesday</span></div>
                                        <div class="progress-group-bars">
                                            <div class="progress progress-xs">
                                    ...
                                    <div class="progress-group mb-4">
                                        <div class="progress-group-prepend"><span
                                                    class="progress-group-text">Wednesday</span></div>
                                        <div class="progress-group-bars">
                                            <div class="progress progress-xs">
                                    ...
                                    <div class="progress-group mb-4">
                                        <div class="progress-group-prepend"><span
                                                    class="progress-group-text">Thursday</span></div>
                                        <div class="progress-group-bars">
                                            <div class="progress progress-xs">
                                    ...
                                    <div class="progress-group mb-4">
                                        <div class="progress-group-prepend"><span
                                                    class="progress-group-text">Friday</span></div>
                                        <div class="progress-group-bars">
                                            <div class="progress progress-xs">
                                    ...
                                    <div class="progress-group mb-4">
                                        <div class="progress-group-prepend"><span
                                                    class="progress-group-text">Saturday</span></div>
                                        <div class="progress-group-bars">
                                            <div class="progress progress-xs">
                                    ...
                                    <div class="progress-group mb-4">
                                        <div class="progress-group-prepend"><span
                                                    class="progress-group-text">Sunday</span></div>
                                        <div class="progress-group-bars">
                                            <div class="progress progress-xs">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header">
                                            <svg class="c-icon progress-group-icon">
                                                <use xlink:href="core/assets/icons/coreui/free-symbol-defs.svg#cui-user"></use>
                                            </svg>
                                            <div>Male</div>
                                    ...
                                    <div class="progress-group mb-5">
                                        <div class="progress-group-header">
                                            <svg class="c-icon progress-group-icon">
                                                <use xlink:href="core/assets/icons/coreui/free-symbol-defs.svg#cui-user-female"></use>
                                            </svg>
                                            <div>Female</div>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header align-items-end">
                                            <svg class="c-icon progress-group-icon">
                                                <use xlink:href="core/assets/icons/coreui/free-symbol-defs.svg#cui-globe-alt"></use>
                                            </svg>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header align-items-end">
                                            <svg class="c-icon progress-group-icon">
                                                <use xlink:href="core/assets/icons/coreui/free-symbol-defs.svg#cui-facebook"></use>
                                            </svg>
                                            <div>Facebook</div>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header align-items-end">
                                            <svg class="c-icon progress-group-icon">
                                                <use xlink:href="core/assets/icons/coreui/free-symbol-defs.svg#cui-twitter"></use>
                                            </svg>
                                            <div>Twitter</div>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header align-items-end">
                                            <svg class="c-icon progress-group-icon">
                                                <use xlink:href="core/assets/icons/coreui/free-symbol-defs.svg#cui-linkedin"></use>
                                            </svg>
                                            <div>LinkedIn</div>
                            ...
                            <table class="table table-responsive-sm table-hover table-outline mb-0">
                                ...
                                <tr>
                                    <th class="text-center">
                                        <svg class="c-icon">
                                            <use xlink:href="core/assets/icons/coreui/free-symbol-defs.svg#cui-people"></use>
                                        </svg>
                                    </th>
                                    <th>User</th>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="c-avatar"><img class="c-avatar-img"
                                                                   src="{{ asset("core/avatars/user.png") }}"
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="core/assets/icons/brands/brands-symbol-defs.svg#cc-mastercard"></use>
                                        </svg>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="core/assets/icons/brands/brands-symbol-defs.svg#cc-visa"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="small text-muted">Last login</div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="core/assets/icons/brands/brands-symbol-defs.svg#cc-stripe"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="small text-muted">Last login</div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="core/assets/icons/brands/brands-symbol-defs.svg#cc-paypal"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="small text-muted">Last login</div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="core/assets/icons/brands/brands-symbol-defs.svg#cc-apple-pay"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="small text-muted">Last login</div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="core/assets/icons/brands/brands-symbol-defs.svg#cc-amex"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="small text-muted">Last login</div>
