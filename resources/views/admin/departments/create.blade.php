        ...
        <div class="fade-in">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="card">
                        <div class="card-header"><strong>Create</strong> a new Department</div>
                        <div class="card-body">
                            <form class="form-horizontal" action="{{route('web.admin.departments.store')}}"
                                  method="post"
                                ...
                                <div class="form-actions">
                                    <a class="btn btn-secondary" type="button"
                                       href="{{route('web.admin.departments.index')}}">Cancel</a>
