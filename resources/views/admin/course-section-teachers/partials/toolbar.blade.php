    ...
    <div class="col-md-8">
        <div class="btn-toolbar float-right" role="toolbar"
            ...
            <div class="btn-group" role="group" aria-label="Third group">
                @if(request('trashed'))
                    <a href="{{route('web.admin.course-section-teachers.index')}}"
                       class="btn btn-dark"
                       type="button">Without Trashed</a>
                @else
                    <a href="{{route('web.admin.course-section-teachers.index',['trashed' => true])}}"
                       class="btn btn-dark"
                       type="button">View Trashed</a>
                @endif
                <a href="{{ route('web.admin.course-section-teachers.create') }}"
