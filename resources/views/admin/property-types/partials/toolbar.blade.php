    ...
    <div class="col-md-8">
        <div class="btn-toolbar float-right" role="toolbar"
            ...
            <div class="btn-group" role="group" aria-label="Third group">
                @if(request('trashed'))
                    <a href="{{route('web.admin.property-types.index')}}"
                       class="btn btn-dark"
                       type="button">Without Trashed</a>
                @else
                    <a href="{{route('web.admin.property-types.index',['trashed' => true])}}"
                       class="btn btn-dark"
                       type="button">View Trashed</a>
                @endif
                <a href="{{ route('web.admin.property-types.create') }}"
        ...
        <div class="card card-body bg-light mb-0">
            ...
            <form class="form-inline">
                <div class="form-group col-md-4 mb-0">
                    <select name="suggested" id="suggested" class="form-control filterable "
                            required>
